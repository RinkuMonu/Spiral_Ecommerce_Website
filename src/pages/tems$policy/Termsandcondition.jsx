...
const termsSections = [
    ...
    },
    {
      ...
      content: [
        ...
        "We shall not be liable to any person for any loss or damage which may arise as a result of any failure by you to protect your password or account. If you know or suspect that someone else knows your password, you should notify us by contacting us immediately through the address provided below. If we have a reason to believe that there is likely to be a breach of security or misuse of the Website, we may require you to change your password or we may suspend your account without any liability to  SPIRAL STYLE FASHION PRIVATE LIMITED."
      ]
    },
    {
      title: "Pricing",
      content: [
        "Prices for products are described on our Website and are incorporated into these Terms by reference. All prices are in Indian rupees which can be change in different currencies. Prices, products and Services may change at www.spiral.fashion discretion.",
    ...
    },
    {
      ...
      content: [
        "We at  SPIRAL STYLE FASHION PRIVATE LIMITED believe that the Debit/Credit card details provided by you to get the services from website will be correct and accurate and you will not provide any card details which are legally not owned by you.",
    ...
    },
    {
      title: "Contact",
      content: [
        "If you still have any query about our terms and conditions kindly drop us an email at  info@spiral.fashion we will reply you within 1-2 working days."
      ]
    }
  ];
