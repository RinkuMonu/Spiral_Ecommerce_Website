...
//             <h1 className="section-heading"><strong>Cookie Policy for SPIRAL STYLE FASHION PRIVATE LIMITED Pvt Ltd</strong></h1>
              ...
              <div className="bg-white rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-purple-950 to-purple-300 p-6 md:p-8">
                  ...
                  <p className="text-indigo-100 mt-4 max-w-3xl">
                    This policy explains how SPIRAL STYLE FASHION PRIVATE LIMITED uses cookies and similar technologies to recognize you when you visit our websites.
                  </p>
                </div>
