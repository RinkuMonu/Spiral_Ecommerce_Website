              ...
              <div className="p-8 space-y-10">
                ...
                <section className="group">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-[#14263F] mb-1">Privacy Policy for SPIRAL STYLE FASHION PRIVATE LIMITED</h3>
                ...
                <section className="group">
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-purple-50 p-6 rounded-xl border-l-4 border-[#C1467F]">
                    <p className="text-gray-700 leading-relaxed">
                      If you have any questions about this Privacy Policy, You can contact us via email at <a href="mailto:spiralfashion4@gmail.com" className="text-[#384D89] hover:text-[#C1467F] transition-colors duration-300">spiralfashion4@gmail.com</a>.
                    </p>
                  </div>
                </section>
              </div>
