                ...
                <div className="mb-12">
                  <div className="bg-gradient-to-r from-[#2A4172] to-[#384D89] p-6 rounded-xl text-white mb-6">
                    <div className="flex items-center">
                      ...
                      <h2 className="text-xl font-bold">SPIRAL STYLE FASHION PRIVATE LIMITED - Service Terms & Conditions</h2>
                    </div>
                  </div>
                </div>
