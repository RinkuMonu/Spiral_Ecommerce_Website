...
const Navbar: React.FC<NavbarProps> = ({ onCartClick, cartItemCount }) => {
  ...
  return (
    <div className="sticky top-0 z-50">
      ...
      <div
        className="relative overflow-hidden text-white text-sm text-center py-3 px-4"
        style={{ background: "linear-gradient(135deg, rgb(108 30 108) 0%, rgb(167 86 135) 50%, rgb(143 0 138) 100%)" }}
      >
      ...
      {/* Main Navbar with authentic traditional styling */}
      <nav className={`relative shadow-xl transition-all duration-300 bg-white ${isSticky ? "pt-2" : "pt-4"}`}>
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center relative group">
              <div className="relative" style={{ borderColor: "rgb(157 48 137)" }}>
                <img
                  src={logo || "/placeholder.svg"}
                  alt="Logo"
                  className={`transition-all duration-300 ${isSticky ? "w-28" : "w-36"} rounded-lg`}
                />
              </div>
            </Link>
                ...
                <form onSubmit={handleSearchSubmit} className="w-full">
                  <div className="relative">
                    <input
                      type="search"
                      id="default-search"
                      className="block w-full pl-6 pr-14 py-4 text-sm rounded-full border-3 bg-gradient-to-r from-slate-50 to-blue-50 focus:outline-none focus:ring-3 transition-all shadow-inner font-medium"
                      style={{
                        borderColor: "rgb(156 45 137)",
                    ...
                    <button
                      type="submit"
                      className="absolute right-2 top-1/2 transform -translate-y-1/2 text-white rounded-full p-3 transition-all shadow-lg border-2 border-white"
                      style={{ background: "linear-gradient(135deg, rgb(149 21 137), rgb(220 133 195))" }}
                    >
                      <Search size={18} />
                    </button>
                  </div>
                    ...
                    >
                      {categories
                        ...
                        .map((cat, index) => (
                          <div
                            key={index}
                            className="px-6 py-4 cursor-pointer transition-all duration-200 flex items-center justify-between border-b last:border-b-0 hover:shadow-md"
                            style={{
                          ...
                          >
                            <span className="font-bold" style={{ color: "#1B2E4F" }}>
                              {cat}
                            </span>
            ...
            <div className="hidden lg:flex items-center space-x-6">
              <div className="relative" ref={userMenuRef}>
                <button
                  ...
                  className="flex items-center space-x-3 transition-all group"
                  style={{ color: "#1B2E4F" }}
                >
                  <div
                    className="w-11 h-11 flex items-center justify-center rounded-full border-3 group-hover:shadow-lg transition-all"
                    style={{
                      background: "linear-gradient(135deg, rgba(56, 77, 137, 0.1), rgba(161, 60, 120, 0.1))",
                      borderColor: "rgb(157 48 137)",
                    }}
                  >
                    <User size={20} style={{ color: "rgb(157 48 137)" }} />
                  </div>
                  {user ? (
                ...
                {userMenuOpen && (
                  <div
                    className="absolute right-0 mt-3 w-64 bg-gradient-to-b from-slate-50 to-blue-50 shadow-2xl rounded-2xl overflow-hidden z-30 border-3"
                    style={{ borderColor: "rgb(157 48 137)" }}
                  >
                    {user ? (
                      <>
                        ...
                        >
                          <p className="text-sm font-bold" style={{ color: "#1B2E4F" }}>
                            {user.firstName} {user.lastName || ""}
                          </p>
                          <p className="text-xs truncate" style={{ color: "rgb(157 48 137)" }}>
                            {user.email}
                          </p>
                        </div>
                        <div className="py-2">
                          <Link
                            to="/wishlist"
                            className="block px-6 py-3 text-sm font-semibold transition-all hover:shadow-md"
                            style={{ color: "#1B2E4F" }}
                            onMouseEnter={(e) => {
                              e.currentTarget.style.background =
                                "linear-gradient(90deg, rgba(56, 77, 137, 0.1), rgba(161, 60, 120, 0.1))"
                        ...
                        <div className="py-2 border-t-2" style={{ borderColor: "rgb(157 48 137)" }}>
                          <button
                            onClick={handleLogout}
                            className="block w-full text-left px-6 py-3 text-sm font-semibold transition-all hover:shadow-md"
                            style={{ color: "#1B2E4F" }}
                            onMouseEnter={(e) => {
                              e.currentTarget.style.background =
                      ...
                      <div className="py-2">
                        <Link
                          to="/login"
                          className="block px-6 py-4 text-center text-white font-bold transition-all hover:shadow-lg"
                          style={{ background: "linear-gradient(135deg, rgb(157 48 137), #2A4172)" }}
                          onClick={() => setUserMenuOpen(false)}
                        >
                          Login / Register
                        </Link>
                        <div className="p-6">
                          <p className="text-xs text-center font-medium" style={{ color: "rgb(157 48 137)" }}>
              ...
              <button
                ...
                className="relative p-3 transition-all group rounded-full"
                style={{ color: "#1B2E4F" }}
              >
                <div
                ...
                {wishlistCount > 0 && (
                  <span
                    className="absolute -top-1 -right-1 text-white text-xs font-bold rounded-full w-6 h-6 flex items-center justify-center border-2 border-white shadow-lg"
                    style={{ background: "linear-gradient(135deg, #A13C78, #872D67)" }}
                  >
                    {wishlistCount}
                  </span>
                ...
                <form onSubmit={handleSearchSubmit} className="w-full">
                  <div className="relative">
                    <input
                      type="search"
                      id="mobile-search"
                      className="block w-full pl-6 pr-14 py-4 text-sm rounded-full border-3 bg-gradient-to-r from-slate-50 to-blue-50 focus:outline-none focus:ring-3 font-medium"
                      style={{
                        borderColor: "rgb(157 48 137)",
                        color: "#1B2E4F",
                      }}
                    ...
                    <button
                      type="submit"
                      className="absolute right-2 top-1/2 transform -translate-y-1/2 text-white rounded-full p-3 transition-all"
                      style={{ background: "linear-gradient(135deg, rgb(157 48 137), #2A4172)" }}
                    >
                      <Search size={18} />
                    </button>
        ...
        {/* Desktop Category Navigation with traditional design */}
        <div
          className="relative border-t-2 mt-4"
          style={{
            background: "linear-gradient(135deg, rgba(56, 77, 137, 0.05), rgba(161, 60, 120, 0.05))",
            borderColor: "rgb(157 48 137)",
          }}
        >
          <div className="container mx-auto px-4 relative z-10">
            <div className="flex items-center justify-between py-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                >
                  <div className="w-1.5 h-1.5 rounded-full" style={{ background: "rgb(157 48 137)" }}></div>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-1">
                {categories.slice(0, 6).map((item) => (
                  <Link
                    ...
                    className="relative group px-2 text-sm font-bold transition-all duration-300"
                    style={{
                      color: "#1B2E4F",
                      // background: "rgba(157, 48, 137, 0.08)",
                      // borderColor: "rgba(157, 48, 137, 0.2)",
                    }}
                    onMouseEnter={(e) => {
                      e.currentTarget.style.color = "#1B2E4F"
                      // e.currentTarget.style.background = "linear-gradient(135deg, rgb(157 48 137), rgb(135, 45, 103))"
                    ...
                    onMouseLeave={(e) => {
                      e.currentTarget.style.color = "#1B2E4F"
                      e.currentTarget.style.background = "linear-gradient(135deg, rgb(255 255 255 / 5%), rgb(255 201 233 / 5%))"
                  ...
                  >
                    ...
                    ></div>
                    <div
                      className="absolute -bottom-0.5 -left-0.5 w-2 h-2 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300"
                ...
                {categories.length > 6 && (
                  <div className="relative" ref={moreMenuRef}>
                    <button
                      ...
                      className="relative px-6 py-3 text-sm font-bold transition-all duration-300 rounded-full flex items-center space-x-2 group"
                      style={{
                        color: "#1B2E4F",
                      }}
                      onMouseEnter={(e) => {
            ...
            <div className="flex flex-col h-full relative">
              ...
              >
                ...
                <button
                  ...
                  className="absolute top-4 right-4 text-white hover:text-blue-200 focus:outline-none z-10"
                >
                  <X size={28} />
                </button>
                {user ? (
                  <div className="flex items-center space-x-4 relative z-10">
                    <div className="w-12 h-12 flex items-center justify-center bg-white bg-opacity-20 text-white rounded-full border-2 border-white border-opacity-30">
                      <User size={24} />
                    </div>
                    <div>
                  ...
                  <div className="space-y-4 relative z-10">
                    <p className="text-white font-bold text-lg">Welcome to Heritage Store!</p>
                    <div className="flex space-x-3">
                      <Link
                        to="/login"
                        className="flex-1 bg-white bg-opacity-20 text-white text-center py-3 rounded-lg font-bold border-2 border-white border-opacity-30 hover:bg-opacity-30 transition-all"
                        onClick={() => setMenuOpen(false)}
                      >
                        Login
                      </Link>
                      <Link
                        to="/register"
                        className="flex-1 bg-white text-center py-3 rounded-lg font-bold hover:bg-blue-50 transition-all"
                        style={{ color: "rgb(157 48 137)" }}
                        onClick={() => setMenuOpen(false)}
                      >
                        Register
              ...
              <div className="flex-1 overflow-y-auto">
                <div className="py-4">
                  <h3
                    className="px-6 py-3 text-xs font-bold uppercase tracking-wider border-b-2"
                    style={{
                      color: "#1B2E4F",
                      borderColor: "rgb(157 48 137)",
                    }}
                  ...
                  <div className="space-y-1 mt-2">
                    {categories.map((item) => (
                      <Link
                        key={item}
                        to={`/category/${item.toLowerCase()}`}
                        className="block px-6 py-4 font-semibold transition-all border-l-4 border-transparent"
                        style={{ color: "#1B2E4F" }}
                        onMouseEnter={(e) => {
                          e.currentTarget.style.background =
                            "linear-gradient(90deg, rgba(56, 77, 137, 0.1), rgba(161, 60, 120, 0.1))"
                ...
                <div className="py-4 border-t-2" style={{ borderColor: "rgb(157 48 137)" }}>
                  <h3 className="px-6 py-3 text-xs font-bold uppercase tracking-wider" style={{ color: "#1B2E4F" }}>
                    Your Account
                  </h3>
                  <div className="space-y-1 mt-2">
                    <Link
                    ...
                    >
                      ...
                      {wishlistCount > 0 && (
                        <span
                          className="ml-3 text-white text-xs px-3 py-1 rounded-full font-bold"
                          style={{ background: "linear-gradient(135deg, #A13C78, #872D67)" }}
                        >
                          {wishlistCount}
                        </span>
                ...
                {user && (
                  <div className="p-6 border-t-2" style={{ borderColor: "rgb(157 48 137)" }}>
                    <button
                      onClick={handleLogout}
                      className="w-full py-4 px-6 rounded-lg font-bold transition-all border-2"
                      style={{
                        background: "linear-gradient(135deg, rgba(56, 77, 137, 0.1), rgba(161, 60, 120, 0.1))",
                        color: "#1B2E4F",
                        borderColor: "rgb(157 48 137)",
