...
//           <span className="text-[#5252a2]">New Arrivals</span> Products
//         </h2>
...
//             Discover our most New Arrivals items loved by customers worldwide
//           </p>
//         </div>
...
//                     <Heart
//                       size={18}
//                       className={hoveredProduct === product.id ? "text-rose-500" : ""}
//                     />
//                   </button>
//                 </div>
...
//                 <button
//                   onClick={() => addToCart(product)}
//                   className={`absolute bottom-0 left-0 w-full bg-indigo-600 text-white py-3 text-center font-medium transition-all duration-300 ${hoveredProduct === product.id
...
const Arrivals = ({ addToCart }: { addToCart: (product: any) => void }) => {
  ...
  return (
    <section className="py-16 bg-gradient-to-b from-purple-200 rounded-t-[100px] to-white px-4 sm:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center mb-4">
            <div className="w-12 h-0.5 bg-indigo-600 mr-4"></div>
