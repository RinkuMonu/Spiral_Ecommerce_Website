                  ...
                  {products.slice(slideIndex * itemsPerSlide, (slideIndex + 1) * itemsPerSlide).map((product) => (
                    ...
                    >
                      ...
                      <div className="relative aspect-square overflow-hidden">
                        ...
                        <button
                          onClick={() => handleAddToCart(product)}
                          className={`absolute bottom-0 left-0 w-full text-white py-3 text-center font-semibold transition-all duration-300 z-20 ${hoveredProduct === product._id ? "translate-y-0 opacity-100" : "translate-y-full opacity-0"
                            }`}
                          style={{ background: "rgb(157 48 137)" }}
                        >
                          ADD TO CART
                      ...
                      <div className="p-5">
                        <div className="mb-3">
                          <Link to={`/product/${product._id}`} className="text-lg font-bold mb-1 line-clamp-1" style={{ color: "#1B2E4F" }}>
                            {product.productName}
                          </Link>
